...
\begin{figure}
  ...
  \caption[Arquitectura del comando y control.]{Arquitectura del comando y control.}%
...
El cuadro de mando ha sido desarrollado en la misma tecnología principal utilizada en la mayoría de los otros componentes, Python. Esta vez, se hace uso de Streamlit~\cite{streamlit2025faster}, un componente para construir herramientas interactivas.
