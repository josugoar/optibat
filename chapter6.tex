...
\begin{samepage}
  ...
  \begin{subequations}%
    ...
    \begin{equation}
      B_{\text{inf}, t} = \mathrm{SoC}_{t} \le \left( \frac{\mathrm{SoC}_{\text{mín}}}{100} + \frac{\mathrm{SoC}_{\text{tol}}}{100} \right) \cdot E_{\text{cap}}
    \end{equation}

    \begin{equation}
      B_{\text{sup}, t} = \mathrm{SoC}_{t} \ge ( \min(\frac{\mathrm{SoC}_{\text{máx}}}{100}, \frac{A}{100}, \frac{\text{SoH}}{100}) - \frac{\mathrm{SoC}_{\text{tol}}}{100} ) \cdot E_{\text{cap}}
    \end{equation}
  ...
  \begin{itemize}
    ...
    \item \( \text{SoH} \) es el \gls{soh} de la batería.
