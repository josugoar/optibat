...
\newacronym[longplural=costes capitales]{capex}{CAPEX}{coste de capital}
...
\newacronym[longplural=extracciones-transformaciones-cargas]{etl}{ETL}{extracción-transformación-carga}
...
\newacronym[longplural=informaciones a 90 días]{i90dia}{I90DIA}{información a 90 días}
...
\newacronym[longplural=internets de las cosas industriales]{iiot}{IIoT}{internet de las cosas industrial}
...
\newacronym[longplural=programaciones lineales]{lp}{LP}{programación lineal}

\newacronym[longplural=programas diarios básicos de casación marginal]{marginalpdbc}{MARGINALPDBC}{programa diario básico de casación marginal}

\newacronym[longplural=programas intradiarios básicos de casación incremental marginal]{marginalpibci}{MARGINALPIBCI}{programa diario básico de casación incremental marginal}
...
\newacronym[longplural=programaciones lineales de enteros mixtas]{milp}{MILP}{programación lineal de enteros mixta}
...
\newacronym[longplural=programas intradiarios básicos de casación acumulados]{pibca}{PIBCA}{programa intradiario básico de casación acumulado}
...
\newacronym[longplural=operadores del sistema de transmisión]{tso}{TSO}{operador del sistema de transmisión}
